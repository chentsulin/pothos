...
declare global {
    export namespace PothosSchemaTypes {
        ...
        export interface SchemaBuilder<Types extends SchemaTypes> {
            ...
            simpleInterface: <Fields extends FieldMap, Shape extends OutputShapeFromFields<Fields>, Interfaces extends InterfaceParam<SchemaTypes>[]>(name: string, options: SimpleInterfaceTypeOptions<Types, Fields, Shape, Interfaces>, fields?: InterfaceFieldsShape<Types, Shape>) => InterfaceRef<Types, Shape>;
        }
