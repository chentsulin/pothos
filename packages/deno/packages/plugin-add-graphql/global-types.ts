...
declare global {
    export namespace PothosSchemaTypes {
        ...
        export interface SchemaBuilder<Types extends SchemaTypes> {
            addGraphQLObject: <Shape>(type: GraphQLObjectType<Shape>, options: AddGraphQLObjectTypeOptions<Types, Shape>) => ObjectRef<Types, Shape>;
            ...
            addGraphQLEnum: <Shape extends number | string>(type: GraphQLEnumType, options: AddGraphQLEnumTypeOptions<Types, EnumValuesWithShape<Types, Shape>>) => EnumRef<Types, Shape>;
